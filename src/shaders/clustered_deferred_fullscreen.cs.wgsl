...
@group(3) @binding(0) var gbufferBaseColor: texture_2d<f32>;
@group(3) @binding(1) var gbufferNormal: texture_2d<f32>;
@group(3) @binding(2) var gbufferDepth: texture_2d<f32>;
@group(3) @binding(3) var frameBuffer: texture_storage_2d<rgba8unorm, write>;
